...
<a href="{{ route('transaksi.create') }}" class="btn btn-primary mb-3" style="background-color: #0e7688; color: white;">Tambah Transaksi</a>
                ...
                <div class="d-flex">
                    ...
                    <form action="{{ route('transaksi.destroy', $trx->id) }}" method="post">
                        ...
                        <button type="submit" class="btn rounded-circle py-2"
                            style="background-color: rgb(253, 0, 0);"
                    ...
                    <a href="{{ url('/dashboard/laporan-transaksi/'. $trx->kode_invoice) }}" class="btn ml-2 rounded-circle py-2"
                        style="background-color: rgb(0, 112, 15);"><i class="fas fa-fw fa-print text-white"></i></a>
                </div>
            </td>
        </tr>
        @endforeach
