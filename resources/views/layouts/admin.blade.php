...
<head>
    ...
    <meta name="author" content="Achmad Setiawan A">

    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>Di Dimas Laundry</title>
    ...
    <!-- Favicon -->
    <link href="{{ asset('img/mesin-cuci.png') }}" rel="icon" type="image/png">
...
<body id="page-top">
    ...
    <div id="wrapper">
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #0e7688;">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
                ...
                <div class="sidebar-brand-text mx-3">Welcome {{ Auth::user()->role }}</div>
            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Dimas Fadhillah R :2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Apakah Anda Benar-Benar Ingin LogOut</div>
