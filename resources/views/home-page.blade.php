...
<body>
            ...
            <div class="row">
                <div class="col-md-6 text-center text-lg-left mb-2 mb-lg-0">
                    <div class="d-inline-flex align-items-center">
                        <a class="text-white pl-3" href="/login">Login</a>
                    </div>
                </div>
        ...
        <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 pl-3 pl-lg-5">
                <a href="" class="navbar-brand">
                    <h1 class="m-0 text-secondary"><span class="text-primary">Di</span> Dimas Laundry</h1>
                </a>
        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-80" src="img/bga.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Baju Bersih Anda pun Nyaman</h4>
                            <h1 class="display-3 text-white mb-md-4">Jasa Layanan Pencucian Baju</h1>                            
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="w-80" src="img/bag.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Baju Bersih Andapun Nyaman</h4>
                            <h1 class="display-3 text-white mb-md-4">Dilayani dengan Staff yang Professional </h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 d-flex align-items-center justify-content-center bg-secondary mb-4 mb-lg-0"
                    ...
                    <div class="d-inline-flex text-left">
                        ...
                        <div class="d-flex flex-column">
                            <h5 class="text-white font-weight-medium">Panggilan Kami</h5>
    ...
    {{-- <div class="container-fluid py-5" id="about">
        <div class="container pt-0 pt-lg-4">
                    ...
                    <div class="row">
                        <div class="col-lg-7 m-0 my-lg-5 pt-0 pt-lg-5 pr-lg-5">
                            ...
                            <p>
                                ...
                                berantakan? Tenang, Di Dimas Laundry bisa bantu kamu ngelaundry sambil menikmati waktu
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="d-flex flex-column align-items-center justify-content-center text-center mb-5">
                                ...
                                <h3 class="font-weight-bold m-0 mt-2">Tempat Pesanan</h3>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="d-flex flex-column align-items-center justify-content-center text-center mb-5">
            ...
            <!-- Pricing Plan Start -->
            {{-- <div class="container-fluid pt-5 pb-3" id="pricing">
                <div class="container">
                    <h6 class="text-secondary text-uppercase text-center font-weight-medium mb-3">HARGA TERBAIK</h6>
                    <h1 class="display-4 text-center mb-5">Harga Paket Laundry</h1>
                    <div class="row">
                                ...
                                <div class="d-inline-flex flex-column align-items-center justify-content-center bg-secondary rounded-circle shadow mt-2 mb-4"
                                    ...
                                    <h1 class="display-4 text-white mb-0">
                                        <small class="align-top"
                                            style="font-size: 22px; line-height: 45px;"></small>9<small
                                            class="align-bottom" style="font-size: 16px; line-height: 40px;">rb /
                                            Kg</small>
                                    </h1>
                                </div>
                                <div class="d-flex flex-column align-items-center py-3">
                                    <p>Min Berat 5Kg</p>
                                    <p>Layanan 24 Jam Selesai</p>
            ...
            {{-- <div class="container-fluid py-5">
                <div class="container">
                    ...
                    <h1 class="display-4 text-center mb-5">Riview Pelanggan Kami</h1>
            ...
            <!-- Blog Start -->
            {{-- <div class="container-fluid mt-5 pb-2" id="blog">
                <div class="container">
                            ...
                            <div class="shadow mb-4">
                                <div class="position-relative">
                                    ...
                                    <a href=""
                                        ...
                                        <h4 class="text-center text-white font-weight-medium mb-3">Dolor site amet clita
                                            kasd sanct ipsum</h4>
                                        <div class="d-flex text-light">
                                            <small class="mr-2"><i class="fa fa-user text-secondary"></i> Admin</small>
                                            <small class="mr-2"><i class="fa fa-folder text-secondary"></i> Web
                                                Design</small>
                                            <small class="mr-2"><i class="fa fa-comments text-secondary"></i> 15</small>
                                        </div>
                                    </a>
                                </div>
                                <p class="m-0 p-4">Amet dolores labore magna et amet tempor dolor et dolor. Et sit ipsum
                                    et eos rebum labore ea labore sea. Et sed elitr labore sed labore. Lorem et lorem
                                    amet sed sed kasd ipsum rebum</p>
                            </div>
                        </div>
                        <div class="col-lg-4 mb-2">
                            <div class="shadow mb-4">
            ...
            <div class="container-fluid bg-primary text-white mt-5 pt-5 px-sm-3 px-md-5" id="contact">
                <div class="row pt-5">
                    <div class="col-lg-5 col-md-5 mb-5">
                        <a href="">
                            <h1 class="text-secondary mb-3"><span class="text-white">Di</span> Dimas Laundry</h1>
                        </a>
                        <p>Baju Bersih Anda pun Nyaman</p>
                    ...
                    <div class="col-lg-5 col-md-5 mb-5">
                        <h4 class="text-white mb-4">Lokasi Kita</h4>
                        <p><i class="fa fa-map-marker-alt mr-2"></i>JL. Pahlawan No.5, Surabaya, Jawa-Timur</p>
                        <p><i class="fa fa-phone-alt mr-2"></i>+3948217</p>
                        <p><i class="fa fa-envelope mr-2"></i>Laundryinaja@example.com</p>
                    </div>
            ...
            <div class="container-fluid bg-dark text-white py-4 px-sm-3 px-md-5">
                <p class="m-0 text-center text-white">
                    &copy; <a class="text-white font-weight-medium" href="#">Dimas Laundry</a>..

                    <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                    Designed by <a class="text-white font-weight-medium" >Dimas Fadhillah</a>
                </p>
            </div>
            <!-- Footer End -->
